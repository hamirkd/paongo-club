...
FROM investissement_plan WHERE supprimer='0'";
...
if($num > 0){
  ...
  while ($row = $stmt->fetch()){
    ...
    $policies[$i]['nomprenom'] = $row['nomprenom'];
    $policies[$i]['emailadresse'] = $row['emailadresse'];
    $policies[$i]['telephone'] = $row['telephone'];
